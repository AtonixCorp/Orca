...
try:
    from training.prepare_dataset import DEFAULT_SYSTEM_PROMPT, build_chat_example, load_records
except ModuleNotFoundError:
    from prepare_dataset import DEFAULT_SYSTEM_PROMPT, build_chat_example, load_records


DEFAULT_OUTPUT_DIR = Path("output/smartcito-lora")
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset", default="datasets/sample_training_data.json")
