<!--
================================================================================
 File: orcaapi/README.md
 Purpose: Dev quickstart for the Orca Python orcaapi.
================================================================================
-->

# Orca Orcaapi (FastAPI)

The Python service that powers the Orca Urban Data Backbone API.

## Container Image

- Build file: `orcaapi/Dockerfile`
- What the image does: runs the production FastAPI API on port `8000` with `uvicorn app.main:app`.
- What ships in the image: the full `orcaapi/` application tree and this README at `/app/README.md`.
