...
class Settings(BaseSettings):
    ...
    app_name: str = "Orca"
    app_host: str = "0.0.0.0"  # noqa: S104  # nosec B104 - binding intentional for container runtime
    app_port: int = 8000
    log_level: str = "INFO"
    ...
    gps_udp_host: str = "0.0.0.0"  # nosec B104 - UDP listener is intentionally host-bound
