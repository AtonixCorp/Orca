<!--
================================================================================
 File: docs/wiki/ORCA_MAP_INTEGRATION.md
 Purpose:
   GitHub Wiki-ready page for Orca IoT, GPS, map, Raspberry Pi, and
   camera overlay integration.
================================================================================
-->

# Orca Map Integration

Orca map integration connects IoT devices, GPS metadata, verified trust
...
payload = {
    ...
    "sensor_value": 0.82,
    "mqtt_topic": "orca/pi/raspi-mobile-002/events",
}
...
- GPS and event transport should use TLS and Orca's quantum-ready envelope
...
The panel titled `Orca Map Integration` shows the live Leaflet map with
